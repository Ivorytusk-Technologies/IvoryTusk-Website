...
// ../.wrangler/tmp/bundle-rNXORl/checked-fetch.js
...
async function handleSendMail({ request, env, waitUntil }) {
  ...
  const recipients = (env.NOTIFY_EMAILS || "contact@ivorytusk.ai").split(",").map((s) => s.trim()).filter(Boolean);
...
// ../.wrangler/tmp/pages-5zqeNm/functionsRoutes-0.43289068634175154.mjs
var routes = [
  {
...
// ../.wrangler/tmp/bundle-rNXORl/middleware-loader.entry.ts
var import_checked_fetch11 = __toESM(require_checked_fetch());

// ../.wrangler/tmp/bundle-rNXORl/middleware-insertion-facade.js
...
//# sourceMappingURL=functionsWorker-0.2767446200971586.mjs.map
