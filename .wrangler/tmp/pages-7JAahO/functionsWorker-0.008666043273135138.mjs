...
async function sendMail(env, msg) {
  ...
  const encoder = new TextEncoder();
  let buffer = "";
  const readLine = /* @__PURE__ */ __name(async () => {
    while (true) {
  ...
  const readReply = /* @__PURE__ */ __name(async (expected) => {
    const lines = [];
    while (true) {
...
// ../.wrangler/tmp/pages-7JAahO/functionsRoutes-0.07824608635110719.mjs
var routes = [
  {
...
// ../.wrangler/tmp/bundle-yxNnzP/middleware-loader.entry.ts
var import_checked_fetch11 = __toESM(require_checked_fetch());

// ../.wrangler/tmp/bundle-yxNnzP/middleware-insertion-facade.js
...
//# sourceMappingURL=functionsWorker-0.008666043273135138.mjs.map
